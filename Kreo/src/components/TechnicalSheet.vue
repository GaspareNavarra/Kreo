    ...
    <div id="container-info-entrance" class="col-sm-12 container-info-entrance">
      <div class="col-sm-12 col-10">
        ...
        <div id="treatments-button" class="align-button-forward">
          <div id="clear" class="add-treatments col-4 col-sm-2" @click="openAddTreatments()">Trattamento<i class="fa-solid fa-plus clear-data-icon"></i></div>
...
export default {
  ...
  inject: ['openPopUpSave', 'updateTreatments', 'showLoader', 'hideLoader', 'openAddTreatments', 'closeAddTreatments', 'setNewTreatments'],
