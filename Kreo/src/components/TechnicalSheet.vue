    ...
    <div id="container-info-entrance" class="col-sm-12 container-info-entrance">
      <div class="col-sm-12 col-10">
        ...
        <div id="treatments-button" class="align-button-forward mt-2">
          <div
            id="add-treatments"
            class="add-treatments col-4 col-sm-2"
            @click="openAddTreatments()"
          >
            Trattamento<i class="fa-solid fa-plus clear-data-icon"></i>
          </div>
          <div
            id="clear"
            class="clear-data col-4 col-sm-2"
            @click="clearData()"
          >
            Reset<i class="fa-solid fa-trash clear-data-icon"></i>
          </div>
          <div
            id="forward"
            class="forward col-4 col-sm-2"
            @click="openSummaryPage(selectedProduct)"
          >
            Riepilogo<i class="fa-solid fa-arrow-right forward-button"></i>
          </div>
