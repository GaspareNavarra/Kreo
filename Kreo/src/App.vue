<template>
  <div id="MainBody">
    ...
    <div id="scheda-tecnica" class="datasheet_size" :class="{'login-size_pannel col-9 col-sm-5': loginPage, 'Homepage col-11 col-sm-8 mt-4 mt-sm-5': homePage, 'not-found': notFound, 'select_customer_size': selectCustomerPage}">
