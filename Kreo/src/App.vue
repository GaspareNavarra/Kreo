<template>
  <div id="MainBody">
    ...
    <div id="scheda-tecnica" class="datasheet_size" :class="{'login-size_pannel col-7 col-sm-4': loginPage, 'col-sm-8 mt-5 h-75': homePage, 'not-found': notFound, 'select_customer_size': selectCustomerPage}">
